...
[" i embraced the horrors and they embraced me back. now we're in a gay relationship." Image by https://animatedtext.tumblr.com](https://64.media.tumblr.com/80c87645761c5133f610fc4dbd888c50/d995f0d5c8ccad70-bb/s1280x1920/b00324b70ffc9b2da56efc300a8c9e949972b931.gifv)  
...
The third and the last problem that I ran into was my complete unfamiliarity with git and GitHub to save my progress. I wanted to consider this website as a serious project and no serious project can exist without publishing its source code. I managed to find [a video explaining git](https://youtu.be/mJ-qvsxPHpY?si=jNQfZNr7cHTdVdG3), but GitHub was my downfall. I was just too stupid and too unmotivated to figure out how to work with it. So at this point I abandoned the project entirely.  
...
At first I didn't even think about making a whole ass website on my own, with all the hosting and getting a domain. As one of the main reasons to have my own website was to have a blog and an RSS feed with it, I thought about just making a custom theme for my Tumblr blog. Opening up the Tumblr theme editor quickly changed that. I was still not good enough to touch it. So my sight was set on writing a website from scratch.  
  
Hosting a website is expensive, no one can deny that. Having a server and paying for a domain requires money and it is already more than just creating a blog on Tumblr. So, after a lucky find I discovered [neocities](http://neocities.org). It is a very good service to eliminate all of the costs of hosting. There it is, a perfect solution! And it would be perfect for most people, but it was not enough for me. I just didn't want to take any shortcuts, I wanted to go all the way. So Neocities was out too.  
...
- [MDN web docs](https://developer.mozilla.org/en-US/), Mozilla's tutorials and documentation on html, CSS and JavaScript  
- [w3schools](https://www.w3schools.com/), a website with tutorials on different programming languages, including everything you need to make a website  
- [Flaticon](https://www.flaticon.com/), free icons  
- [88x31 GIF collection](https://cyber.dabamos.de/88x31/), all the funky badges  
  
Now that that sucker was ready I was set on getting it hosted.  
  
## **Getting scammed while buying a domain**  
...
At first I found a very nice domain on a Russian DNS provider and I knew it was a good one, cause my dad had already used it and it was his recommendation. I found a nice, inexpensive domain with an SSL certificate: cyberwitch.space. It cost 99 Rubles, or about 1$ (That is extremely cheap if you ever looked at domain prices). BUT, BECAUSE I AM A DUMBASS I left the purchasing part for later, thinking that I should finish the website first (it all happened while I was just tweaking some parts of the finished website) and, as some may already guess from the current domain, I did not buy it. To be more specific, some freaking company from Illinois came and snatched the domain. I was so mad at them (I still hate you btw, hope your business fails, screw you)  
...
Connect to this ip using another device. It should display a  
  
 similar webpage, which signifies that the Apache is working correctly  
[Apache default index.html on Debian](https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fwww.imaginelinux.com%2Fwp-content%2Fuploads%2F2021%2F10%2F1-1120x680.png&f=1&nofb=1&ipt=255ae2f95b62b0fe70b98b086b36801624260caf56d377f3da55a199bea4cc24&ipo=images)  
